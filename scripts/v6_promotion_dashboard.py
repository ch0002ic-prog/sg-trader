...
def main() -> int:
    has_v11_7 = (REPORTS / "v11_7_tuned_profile.json").exists() and (REPORTS / "v11_7_tuned_overrides.csv").exists()
    has_v11_6 = (REPORTS / "v11_6_tuned_profile.json").exists() and (REPORTS / "v11_6_tuned_overrides.csv").exists()
    ...
    if has_v11_7 and has_v11_6:
        baseline_name = "v11_6_tuned"
        baseline_profile = load_profile(REPORTS / "v11_6_tuned_profile.json", mode="aggressive")
        baseline_overrides = load_overrides(REPORTS / "v11_6_tuned_overrides.csv")

        current_name = "v11_7_tuned"
        current_profile = load_profile(REPORTS / "v11_7_tuned_profile.json", mode="aggressive")
        current_overrides = load_overrides(REPORTS / "v11_7_tuned_overrides.csv")

        oot_path = REPORTS / "v11_7b_local_wealth_refine_run1_scan.csv"
        keep_decision = "KEEP_V11_6_TUNED"
        promote_decision = "PROMOTED_V11_7_TUNED"
    elif has_v11_6 and has_v11_5:
        baseline_name = "v11_5_tuned"
        baseline_profile = load_profile(REPORTS / "v11_5_tuned_profile.json", mode="aggressive")
        baseline_overrides = load_overrides(REPORTS / "v11_5_tuned_overrides.csv")

        current_name = "v11_6_tuned"
        current_profile = load_profile(REPORTS / "v11_6_tuned_profile.json", mode="aggressive")
        current_overrides = load_overrides(REPORTS / "v11_6_tuned_overrides.csv")

        oot_path = REPORTS / "v11_6_local_wealth_refine_run1_scan.csv"
        keep_decision = "KEEP_V11_5_TUNED"
        promote_decision = "PROMOTED_V11_6_TUNED"
    elif has_v11_5 and has_v11_3:
